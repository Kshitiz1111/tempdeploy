...
const Sidebar = ({ sidebarWidth }) => {
  ...
  const drawer = (
    <Box
      ...
      sx={{
        overflowX: { xs: "auto", sm: "auto", md: "hidden" }, // Enable scrolling for xs and sm
        "::-webkit-scrollbar": {
          display: { xs: "block", sm: "block", md: "none" } // Show scrollbar for xs and sm
        },
        ...
        boxShadow: { xs: "0 -2px 8px rgba(0, 0, 0, 0.1)", md: "unset" }
      }}
    >
      {/* logo */}
      ...
      <Animate sx={{ flexGrow: 1 }}>
        ...
        >
          ...
          {/* menu group 2 */}
          <List sx={{ display: { xs: "flex", sm: "flex", md: "block" } }}>
            <ListItem sx={{ display: { xs: "none", sm: "none", md: "block" } }}>
